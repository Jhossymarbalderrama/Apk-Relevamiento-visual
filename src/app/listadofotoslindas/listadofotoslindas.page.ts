...
@Component({
  selector: 'app-listadofotoslindas',
  templateUrl: './listadofotoslindas.page.html',
  styleUrls: ['./listadofotoslindas.page.scss'],
})
export class ListadofotoslindasPage implements OnInit {

  //like: boolean = true;
  listCosasLindasDesc: any = [];
  cosasLindas: any = [];
